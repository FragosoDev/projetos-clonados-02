...
coordinates[1] + '"]'), 
document.querySelector('[posX = "' + (coordinates[0]-1) + '"][posY = "' + 
coordinates[1] + '"]'),
document.querySelector('[posX = "' + (coordinates[0]-2) + '"][posY = "' + 
coordinates[1] + '"]')];
...
/*if zmeya vrezaetsya v sebya*/
    if (snakeBody[0].classList.contains('snakeBody')) {
        ...
        snakeBody[0].style.background = 'url(./img/cat2.jpg) center no-repeat';
